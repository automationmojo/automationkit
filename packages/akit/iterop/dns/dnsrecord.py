...
from akit.iterop.dns.dnsconst import DnsLiftimePercent

from akit.xtime import current_time_millis

from akit.iterop.dns.dnsconst import DnsRecordClass
from akit.iterop.dns.dnsconst import DnsRecordType

if TYPE_CHECKING:
    from akit.iterop.dns.dnsincoming import DnsIncoming
    from akit.iterop.dns.dnsoutgoing import DnsOutgoing
