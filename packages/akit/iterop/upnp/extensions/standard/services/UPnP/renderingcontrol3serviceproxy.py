...
class RenderingControl3ServiceProxy(UpnpServiceProxy, LoadableExtension):
    ...
    def action_GetAllowedDefaultTransforms(self, *, extract_returns=True, aspects:AspectsUPnP=DEFAULT_UPNP_ASPECTS):
        """
    ...
    def action_GetAllowedTransforms(self, InstanceID, *, extract_returns=True, aspects:AspectsUPnP=DEFAULT_UPNP_ASPECTS):
        """
    ...
    def action_GetDefaultTransforms(self, *, extract_returns=True, aspects:AspectsUPnP=DEFAULT_UPNP_ASPECTS):
        """
    ...
    def action_GetTransforms(self, InstanceID, *, extract_returns=True, aspects:AspectsUPnP=DEFAULT_UPNP_ASPECTS):
        """
    ...
    def action_SetDefaultTransforms(self, DesiredDefaultTransformSettings, *, aspects:AspectsUPnP=DEFAULT_UPNP_ASPECTS):
        """
    ...
    def action_SetStateVariables(self, InstanceID, RenderingControlUDN, ServiceType, ServiceId, StateVariableValuePairs, *, extract_returns=True, aspects:AspectsUPnP=DEFAULT_UPNP_ASPECTS):
        """
    ...
    def action_SetTransforms(self, InstanceID, DesiredTransformValues, *, aspects:AspectsUPnP=DEFAULT_UPNP_ASPECTS):
        """
