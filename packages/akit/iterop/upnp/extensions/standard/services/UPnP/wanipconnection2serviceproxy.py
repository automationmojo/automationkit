...
class WANIPConnection2ServiceProxy(UpnpServiceProxy, LoadableExtension):
    ...
    def action_AddAnyPortMapping(self, NewRemoteHost, NewExternalPort, NewProtocol, NewInternalPort, NewInternalClient, NewEnabled, NewPortMappingDescription, NewLeaseDuration, *, extract_returns=True, aspects:AspectsUPnP=DEFAULT_UPNP_ASPECTS):
        """
    ...
    def action_DeletePortMappingRange(self, NewStartPort, NewEndPort, NewProtocol, NewManage, *, aspects:AspectsUPnP=DEFAULT_UPNP_ASPECTS):
        """
    ...
    def action_GetListOfPortMappings(self, NewStartPort, NewEndPort, NewProtocol, NewManage, NewNumberOfPorts, *, extract_returns=True, aspects:AspectsUPnP=DEFAULT_UPNP_ASPECTS):
        """
