...
from akit.iterop.upnp.devices.upnpdevice import UpnpDevice
from akit.iterop.upnp.devices.upnprootdevice import UpnpRootDevice
from akit.iterop.upnp.xml.upnpdevice1 import UpnpDevice1Device


from akit.iterop.upnp.extensions.standard.rootdevices.sonos.sonosdevice import SonosDevice, SonosUpnpDevice1Device

from akit.iterop.upnp.extensions.dynamic.services.SonosInc.alarmclock1serviceproxy import AlarmClock1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.audioin1serviceproxy import AudioIn1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.avtransport1serviceproxy import AVTransport1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.connectionmanager1serviceproxy import ConnectionManager1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.contentdirectory1serviceproxy import ContentDirectory1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.deviceproperties1serviceproxy import DeviceProperties1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.groupmanagement1serviceproxy import GroupManagement1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.grouprenderingcontrol1serviceproxy import GroupRenderingControl1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.htcontrol1serviceproxy import HTControl1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.musicservices1serviceproxy import MusicServices1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.qplay1serviceproxy import QPlay1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.queue1serviceproxy import Queue1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.renderingcontrol1serviceproxy import RenderingControl1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.systemproperties1serviceproxy import SystemProperties1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.virtuallinein1serviceproxy import VirtualLineIn1ServiceProxy
from akit.iterop.upnp.extensions.dynamic.services.SonosInc.zonegrouptopology1serviceproxy import ZoneGroupTopology1ServiceProxy
