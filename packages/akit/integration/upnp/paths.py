...
DIR_UPNP_EXTENSIONS_INTEGRATION = os.path.join(VARIABLES.AKIT_DIRECTORY, "upnp", "extensions")
if VARIABLES.AKIT_UPNP_EXTENSIONS_INTEGRATION_BASE is not None:
    DIR_UPNP_EXTENSIONS_INTEGRATION = VARIABLES.AKIT_UPNP_EXTENSIONS_INTEGRATION_BASE
...
DIR_UPNP_SCAN_INTEGRATION = os.path.join(VARIABLES.AKIT_DIRECTORY, "upnp", "scan")
if VARIABLES.AKIT_UPNP_SCAN_INTEGRATION_BASE is not None:
    DIR_UPNP_SCAN_INTEGRATION = VARIABLES.AKIT_UPNP_SCAN_INTEGRATION_BASE
